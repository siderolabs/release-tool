...
#
# Generated on 2022-11-09T18:27:07Z by kres 03328da.
...
all: unit-tests release-tool image-release-tool lint
...
image-release-tool:  ## Builds image for release-tool.
	@$(MAKE) target-$@ TARGET_ARGS="--tag=$(REGISTRY)/$(USERNAME)/release-tool:$(TAG)"
